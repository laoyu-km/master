...
<font color="red">**如果传入`*`，就可以返回文档中所有 HTML 元素。**</font>
...
### 3.15document.addEventListener()，document.removeEventListener()，document.dispatchEvent()
